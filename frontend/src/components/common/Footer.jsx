// frontend/src/components/common/EnhancedFooter.jsx
import { useState } from "react";

const EnhancedFooter = () => {
  const [showQR, setShowQR] = useState({ whatsapp: false, instagram: false });
  const [showEmail, setShowEmail] = useState(false);

  const toggleQR = (platform) => {
    setShowQR({ ...showQR, [platform]: !showQR[platform] });
  };
          ...
          <div className="border-t border-gray-700 pt-6">
            ...
            <div className="flex justify-center space-x-6">
              ...
              <div className="relative">
                ...
                {showQR.whatsapp && (
                  <div
                    className="absolute bottom-full mb-3 left-1/2 transform -translate-x-1/2 bg-white p-4 rounded-2xl shadow-2xl animate-fade-in"
                  ...
                  >
                    ...
                    <img
                      src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://wa.me/YOUR_NUMBER"
                      alt="WhatsApp QR"
              ...
              <div className="relative">
                ...
                {showQR.instagram && (
                  ...
                  >
                    ...
                    <img
                      src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://instagram.com/YOUR_HANDLE"
                      alt="Instagram QR"
                      className="w-40 h-40 mx-auto"
                    />
                    <p className="text-center text-gray-800 text-sm font-semibold mt-2">
              ...
              <div className="relative">
                ...
                {showEmail && (
                  <div className="absolute bottom-full mb-3 left-1/2 transform -translate-x-1/2 bg-white text-gray-800 px-4 py-2 rounded-xl shadow-xl text-sm animate-fade-in">
